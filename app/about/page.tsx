  ...
  return (
    <main className="min-h-screen bg-[#0a0e1a] text-white">
      <section className="mx-auto max-w-4xl px-4 py-16 space-y-10">
        ...
        <h1 className="text-3xl font-extrabold text-white">About Me and the Project</h1>
        ...
        <div className="rounded-2xl border border-zinc-800 bg-[#111827] p-8 space-y-5">
          <h2 className="text-xl font-bold text-white">Why We Exist</h2>
        ...
        {/* Global Access */}
        <div className="rounded-2xl border border-zinc-800 bg-[#111827] p-8 space-y-4">
          <h2 className="text-xl font-bold text-white">Global Access. Local Support.</h2>
          <p className="text-zinc-300 leading-relaxed">
